...
---
### 12. Handling focus and blur Events for Input Validation
...
### 13. Passive Event Listeners for Scroll Optimization

Using passive: true improves performance for scroll events, as the event is not allowed to be prevented.
...
<body style="height: 2000px;">
    <script>
        window.addEventListener('scroll', () => {
            console.log('Scrolled with passive event!');
        }, { passive: true });
    </script>
</body>
</html>
